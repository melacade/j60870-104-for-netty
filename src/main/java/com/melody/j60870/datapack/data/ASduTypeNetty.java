...
public enum ASduTypeNetty {
    ...
    RESERVED_22(22, ASduTypeNetty.reserved),
    RESERVED_23(23, ASduTypeNetty.reserved),
    RESERVED_24(24, ASduTypeNetty.reserved),
    RESERVED_25(25, ASduTypeNetty.reserved),
    RESERVED_26(26, ASduTypeNetty.reserved),
    RESERVED_27(27, ASduTypeNetty.reserved),
    RESERVED_28(28, ASduTypeNetty.reserved),
    RESERVED_29(29, ASduTypeNetty.reserved),
    RESERVED_41(41, ASduTypeNetty.reserved),
    RESERVED_42(42, ASduTypeNetty.reserved),
    RESERVED_43(43, ASduTypeNetty.reserved),
    RESERVED_44(44, ASduTypeNetty.reserved),
    RESERVED_52(52, ASduTypeNetty.reserved),
    RESERVED_53(53, ASduTypeNetty.reserved),
    RESERVED_54(54, ASduTypeNetty.reserved),
    RESERVED_55(55, ASduTypeNetty.reserved),
    RESERVED_56(56, ASduTypeNetty.reserved),
    RESERVED_57(57, ASduTypeNetty.reserved),
    RESERVED_65(65, ASduTypeNetty.reserved),
    RESERVED_66(66, ASduTypeNetty.reserved),
    RESERVED_67(67, ASduTypeNetty.reserved),
    RESERVED_68(68, ASduTypeNetty.reserved),
    RESERVED_69(69, ASduTypeNetty.reserved),
    RESERVED_71(71, ASduTypeNetty.reserved),
    RESERVED_72(72, ASduTypeNetty.reserved),
    RESERVED_73(73, ASduTypeNetty.reserved),
    RESERVED_74(74, ASduTypeNetty.reserved),
    RESERVED_75(75, ASduTypeNetty.reserved),
    RESERVED_76(76, ASduTypeNetty.reserved),
    RESERVED_77(77, ASduTypeNetty.reserved),
    RESERVED_78(78, ASduTypeNetty.reserved),
    RESERVED_79(79, ASduTypeNetty.reserved),
    RESERVED_80(80, ASduTypeNetty.reserved),
    RESERVED_81(81, ASduTypeNetty.reserved),
    RESERVED_82(82, ASduTypeNetty.reserved),
    RESERVED_83(83, ASduTypeNetty.reserved),
    RESERVED_84(84, ASduTypeNetty.reserved),
    RESERVED_85(85, ASduTypeNetty.reserved),
    RESERVED_86(86, ASduTypeNetty.reserved),
    RESERVED_87(87, ASduTypeNetty.reserved),
    RESERVED_88(88, ASduTypeNetty.reserved),
    RESERVED_89(89, ASduTypeNetty.reserved),
    RESERVED_90(90, ASduTypeNetty.reserved),
    RESERVED_91(91, ASduTypeNetty.reserved),
    RESERVED_92(92, ASduTypeNetty.reserved),
    RESERVED_93(93, ASduTypeNetty.reserved),
    RESERVED_94(94, ASduTypeNetty.reserved),
    RESERVED_95(95, ASduTypeNetty.reserved),
    RESERVED_96(96, ASduTypeNetty.reserved),
    RESERVED_97(97, ASduTypeNetty.reserved),
    RESERVED_98(98, ASduTypeNetty.reserved),
    RESERVED_99(99, ASduTypeNetty.reserved),
    RESERVED_108(108, ASduTypeNetty.reserved),
    RESERVED_109(109, ASduTypeNetty.reserved),
    RESERVED_114(114, ASduTypeNetty.reserved),
    RESERVED_115(115, ASduTypeNetty.reserved),
    RESERVED_116(116, ASduTypeNetty.reserved),
    RESERVED_117(117, ASduTypeNetty.reserved),
    RESERVED_118(118, ASduTypeNetty.reserved),
    RESERVED_119(119, ASduTypeNetty.reserved),
    PRIVATE_128(128),
    PRIVATE_129(129),
    PRIVATE_130(130),
    PRIVATE_131(131),
    ...
    private static final String reserved = "Reserved ASduTypeNetty for further compatible definitions";
    private final int id;
    private final String description;

    private static final Map<Integer,ASduTypeNetty> idMap = new HashMap<>();

    static {
        for (ASduTypeNetty enumInstance : ASduTypeNetty.values()) {
    ...
    private ASduTypeNetty(int id) {
        this(id, "private range");
    }

    private ASduTypeNetty(int id, String description) {
        this.id = id;
        this.description = description;
    }

    /**
     * Returns the description of this com.sac.one_zero_four.datapack.data.ASduTypeNetty.
     * 
    ...
    /**
     * Returns the ID of this com.sac.one_zero_four.datapack.data.ASduTypeNetty.
     * 
     * @return the ID
     */
    public int getId() {
    ...
    /**
     * Returns the com.sac.one_zero_four.datapack.data.ASduTypeNetty that corresponds to the given ID. Returns <code>null</code> if no com.sac.one_zero_four.datapack.data.ASduTypeNetty with the given ID
     * exists.
     * 
     * @param id
     *            the ID
     * @return the com.sac.one_zero_four.datapack.data.ASduTypeNetty that corresponds to the given ID
     */
    public static ASduTypeNetty typeFor(int id) {
        return idMap.get(id);
    }
}